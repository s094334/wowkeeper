...
export function PrivacyText() {
  return (
    <>
      <p className="text-ink-muted text-sm leading-relaxed text-pretty pb-1">
        本網站為學習用途而做的專題，不是正式服務。辨識可能會有誤，請自行確認家電上的銘牌;由於本網站可能進行變動，對於資料存取不負任何責任。
      </p>
      <p className="text-ink-muted text-sm leading-relaxed text-pretty">
        照片只用於辨識銘牌文字，我們不會將照片存入任何資料庫或檔案儲存空間，辨識完成後立即刪除。辨識會交由
